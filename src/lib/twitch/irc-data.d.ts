...
export declare type TwitchIrcPrivmsg = IrcPrivmsg<{
    "badge-info": string;
    "badges": string;
    "color": string;
    "display-name": string;
...
export declare type TwitchIrcClearchat = IrcClearchat<{
    "ban-duration": number;
    "room-id": number;
    "target-user-id": number;
    "tmi-sent-ts": number;
}>;
export declare type TwitchIrcUsernotice = IrcUsernotice<{
    "badge-info": string;
    "color": string;
    "display-name": string;
    "emotes": string | 0;
...
export declare type TwitchIrcUserstate = IrcUserstate<{
    "badge-info": string;
    "badges": string;
    "color": string;
    "display-name": string;
...
export declare type TwitchIrcRoomstate = IrcRoomstate<{
    "emote-only": 1 | 0;
