...
export declare type IrcEvent = IrcEventMap[keyof IrcEventMap];
export declare function ircEventIs<K extends IrcEvent["event"], EventMap extends IrcEventMap>(kind: K): (e: IrcEvent) => e is EventMap[K];
